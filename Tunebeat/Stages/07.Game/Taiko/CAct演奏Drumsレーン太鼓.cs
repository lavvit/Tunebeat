...
namespace TJAPlayer3
{
    internal class CAct演奏Drumsレーン太鼓 : CActivity
    {
        ...
        public override int On進行描画()
        {
            ...
            {
                for (int i = 0; i < 4; i++)
                    this.stBranch[i].nフラッシュ制御タイマ = TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値;
            ...
            if (TJAPlayer3.Tx.Lane_Background_Main != null)
            {
                ...
                {
                    TJAPlayer3.Tx.Lane_Background_Main.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i]);
                }
            }
            #endregion
            for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
            {
                #region[ 分岐アニメ制御タイマー ]
                double num = TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値;
                    ...
                    switch (TJAPlayer3.stage演奏ドラム画面.n次回のコース[i])
                    {
                        case 0:
                            if (TJAPlayer3.Tx.Lane_Base[0] != null)
                            {
                                ...
                                TJAPlayer3.Tx.Lane_Base[0].t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i]);
                            }
                            break;
                        case 1:
                            if (TJAPlayer3.Tx.Lane_Base[1] != null)
                            {
                                ...
                                TJAPlayer3.Tx.Lane_Base[1].t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i]);
                            }
                            break;
                        case 2:
                            if (TJAPlayer3.Tx.Lane_Base[2] != null)
                            {
                                ...
                                TJAPlayer3.Tx.Lane_Base[2].t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i]);
                            }
                            break;
                    }
                    #endregion
                    ...
                    if (TJAPlayer3.ConfigIni.nBranchAnime == 1)
                    {
                        ...
                        if (this.stBranch[i].ct分岐アニメ進行.b進行中)
                        {
                            ...
                            if (this.stBranch[i].nBefore == 0 && this.stBranch[i].nAfter == 1)
                            {
                                ...
                                {
                                    TJAPlayer3.Tx.Lane_Base[0].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                    TJAPlayer3.Tx.Lane_Base[1].Opacity = this.stBranch[i].nBranchレイヤー透明度;
                                    TJAPlayer3.Tx.Lane_Base[1].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                }
                            }
                            //普通→達人
                            if (this.stBranch[i].nBefore == 0 && this.stBranch[i].nAfter == 2)
                            {
                                ...
                                {
                                    TJAPlayer3.Tx.Lane_Base[0].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                    TJAPlayer3.Tx.Lane_Base[2].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
            ...
            for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
            {
                ...
                if (TJAPlayer3.Tx.Lane_Background_GoGo != null && TJAPlayer3.stage演奏ドラム画面.bIsGOGOTIME[i])
                {
                    ...
                    if (this.ctゴーゴー.n現在の値 <= 4)
                    {
                        ...
                        TJAPlayer3.Tx.Lane_Background_GoGo.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i] + 54);
                    }
                    else if (this.ctゴーゴー.n現在の値 <= 5)
                    {
                        TJAPlayer3.Tx.Lane_Background_GoGo.vc拡大縮小倍率.Y = 0.4f;
                        TJAPlayer3.Tx.Lane_Background_GoGo.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i] + 40);
                    }
                    else if (this.ctゴーゴー.n現在の値 <= 6)
                    {
                        TJAPlayer3.Tx.Lane_Background_GoGo.vc拡大縮小倍率.Y = 0.6f;
                        TJAPlayer3.Tx.Lane_Background_GoGo.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i] + 26);
                    }
                    else if (this.ctゴーゴー.n現在の値 <= 8)
                    {
                        TJAPlayer3.Tx.Lane_Background_GoGo.vc拡大縮小倍率.Y = 0.8f;
                        TJAPlayer3.Tx.Lane_Background_GoGo.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i] + 13);
                    }
                    else if (this.ctゴーゴー.n現在の値 >= 9)
                    {
                        TJAPlayer3.Tx.Lane_Background_GoGo.vc拡大縮小倍率.Y = 1.0f;
                        TJAPlayer3.Tx.Lane_Background_GoGo.t2D描画(TJAPlayer3.Skin.nScrollFieldBGX[i], TJAPlayer3.Skin.nScrollFieldY[i]);
                    }
                }
                #endregion
            }
                        ...
                        if (!this.stBranch[i].ct分岐アニメ進行.b進行中)
                        {
                            switch (TJAPlayer3.stage演奏ドラム画面.n次回のコース[i])
                            {
                                case 0:
                                    ...
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                    break;
                                case 1:
                                    TJAPlayer3.Tx.Lane_Text[1].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                    break;
                                case 2:
                                    TJAPlayer3.Tx.Lane_Text[2].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                                    break;
                            }
                        }
                        if (this.stBranch[i].ct分岐アニメ進行.b進行中)
                        {
                            ...
                            if (this.stBranch[i].nBefore == 0 && this.stBranch[i].nAfter == 1)
                            {
                                ...
                                if (this.stBranch[i].ct分岐アニメ進行.n現在の値 < 60)
                                {
                                    ...
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i] + this.stBranch[i].nY);
                                    TJAPlayer3.Tx.Lane_Text[1].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] - 30) + this.stBranch[i].nY);
                                }
                                else
                                {
                                    TJAPlayer3.Tx.Lane_Text[1].Opacity = 255;
                            ...
                            if (this.stBranch[i].nBefore == 0 && this.stBranch[i].nAfter == 2)
                            {
                                ...
                                {
                                    this.stBranch[i].nY = this.stBranch[i].ct分岐アニメ進行.n現在の値 / 2;
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] - 12) + this.stBranch[i].nY);
                                    TJAPlayer3.Tx.Lane_Text[0].Opacity = this.stBranch[i].ct分岐アニメ進行.n現在の値 > 100 ? 0 : (255 - ((this.stBranch[i].ct分岐アニメ進行.n現在の値 * 0xff) / 100));
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] - 20) + this.stBranch[i].nY);
                                }
                                ...
                                else if (this.stBranch[i].ct分岐アニメ進行.n現在の値 >= 150 && this.stBranch[i].ct分岐アニメ進行.n現在の値 < 210)
                                {
                                    ...
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i] + this.stBranch[i].nY);
                                    TJAPlayer3.Tx.Lane_Text[1].Opacity = this.stBranch[i].ct分岐アニメ進行.n現在の値 > 100 ? 0 : (255 - ((this.stBranch[i].ct分岐アニメ進行.n現在の値 * 0xff) / 100));
                                    TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] - 20) + this.stBranch[i].nY);
                                }
                                else
                                {
                                    TJAPlayer3.Tx.Lane_Text[2].Opacity = 255;
                            ...
                            if (this.stBranch[i].nBefore == 1 && this.stBranch[i].nAfter == 0)
                            {
                                ...
                                if (this.stBranch[i].ct分岐アニメ進行.n現在の値 < 60)
                                {
                                    this.stBranch[i].nY = this.stBranch[i].ct分岐アニメ進行.n現在の値 / 2;
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i] - this.stBranch[i].nY);
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] + 30) - this.stBranch[i].nY);
                                }
                                else
                                {
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i]);
                            ...
                            if (this.stBranch[i].nBefore == 2 && this.stBranch[i].nAfter == 0)
                            {
                                ...
                                if (this.stBranch[i].ct分岐アニメ進行.n現在の値 < 60)
                                {
                                    ...
                                    TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, TJAPlayer3.Skin.nScrollFieldY[i] - this.stBranch[i].nY);
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, (TJAPlayer3.Skin.nScrollFieldY[i] + 30) - this.stBranch[i].nY);
                                }
                                else if (this.stBranch[i].ct分岐アニメ進行.n現在の値 >= 60 && this.stBranch[i].ct分岐アニメ進行.n現在の値 < 150)
                                {
                    ...
                    else
                    {
                        ...
                        if (this.stBranch[i].nY座標 == 0)
                        {
                            switch (TJAPlayer3.stage演奏ドラム画面.n次回のコース[0])
                            {
                                case 0:
                                    TJAPlayer3.Tx.Lane_Text[0].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, 192);
                                    break;
                                case 1:
                                    TJAPlayer3.Tx.Lane_Text[1].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, 192);
                                    break;
                                case 2:
                                    TJAPlayer3.Tx.Lane_Text[2].Opacity = 255;
                                    TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, 192);
                                    break;
                            }
                        }
                        ...
                        if (this.stBranch[i].nY座標 != 0)
                        {
                            ...
                            if (this.stBranch[i].nBefore == 0 && this.stBranch[i].nAfter == 1)
                            {
                                TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, 192 - this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, 212 - this.stBranch[i].nY座標);
                            ...
                            {
                                TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, 192 - this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, 212 - this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[0].Opacity = this.stBranch[i].nBranchレイヤー透明度;
                            }
                            #endregion
                            #region[ 玄人譜面_レベルアップ ]
                            ...
                            if (this.stBranch[i].nBefore == 1 && this.stBranch[i].nAfter == 2)
                            {
                                TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, 192 - this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, 212 - this.stBranch[i].nY座標);
                            ...
                            {
                                TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, 192 + this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, 168 + this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[1].Opacity = this.stBranch[i].nBranchレイヤー透明度;
                            }
                            #endregion
                            #region[ 達人譜面_レベルダウン ]
                            if (this.stBranch[i].nBefore == 2 && this.stBranch[i].nAfter == 0)
                            {
                                TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, 192 + this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[0].t2D描画(333, 168 + this.stBranch[i].nY座標);
                            ...
                            {
                                TJAPlayer3.Tx.Lane_Text[2].t2D描画(333, 192 + this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[1].t2D描画(333, 168 + this.stBranch[i].nY座標);
                                TJAPlayer3.Tx.Lane_Text[2].Opacity = this.stBranch[i].nBranchレイヤー透明度;
                            }
                            #endregion
                        }
            ...
            {
                TJAPlayer3.Tx.Lane_Background_Sub.t2D描画(333, 326);
                if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay)
                {
                    TJAPlayer3.Tx.Lane_Background_Sub.t2D描画(333, 502);
                }
            }
            ...
            {
                TJAPlayer3.Tx.Taiko_Frame[0].t2D描画(329, 136);

                if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay)
                {
                    if(TJAPlayer3.Tx.Taiko_Frame[1] != null)
                    {
                        TJAPlayer3.Tx.Taiko_Frame[1].t2D描画(329, 360);
                    }
                }
            }
            ...
            if (this.n総移動時間 != -1)
            {
                if (n移動方向 == 1)
                {
                    TJAPlayer3.Skin.nScrollFieldX[0] = this.n移動開始X + (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻) / (double)(this.n総移動時間)) * this.n移動距離px);
                    TJAPlayer3.stage演奏ドラム画面.FlyingNotes.StartPointX[0] = this.n移動開始X + (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻) / (double)(this.n総移動時間)) * this.n移動距離px);
                }
                else
                {
                    TJAPlayer3.Skin.nScrollFieldX[0] = this.n移動開始X - (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻) / (double)(this.n総移動時間)) * this.n移動距離px);
                ...
                if (((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値) > this.n移動開始時刻 + this.n総移動時間)
                {
                    this.n総移動時間 = -1;
                }
            }
            if (this.n総移動時間2 != -1)
            {
                if (n移動方向2 == 1)
                {
                    TJAPlayer3.Skin.nScrollFieldX[1] = this.n移動開始X2 + (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻2) / (double)(this.n総移動時間2)) * this.n移動距離px2);
                    TJAPlayer3.Skin.Game_Effect_FlyingNotes_StartPoint_X[1] = this.n移動開始X2 + (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻2) / (double)(this.n総移動時間2)) * this.n移動距離px2);
                }
                else
                {
                    TJAPlayer3.Skin.nScrollFieldX[1] = this.n移動開始X2 - (int)((((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値 - this.n移動開始時刻2) / (double)(this.n総移動時間2)) * this.n移動距離px2);
                ...
                if (((int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値) > this.n移動開始時刻2 + this.n総移動時間2)
                {
                    this.n総移動時間2 = -1;
                }
            }
        ...
        public void ゴーゴー炎()
        {
            ...
            if (TJAPlayer3.Tx.Notes != null)
            {
                ...
                TJAPlayer3.Tx.Judge_Frame.t2D描画(nJudgeX, nJudgeY, new Rectangle(0, 0, 130, 130));

                if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay)
                    TJAPlayer3.Tx.Judge_Frame.t2D描画(nJudgeX, nJudgeY + 176, new Rectangle(0, 0, 130, 130));
            }
            ...
            for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
            {
                if (TJAPlayer3.stage演奏ドラム画面.bIsGOGOTIME[i])
                {
                    ...
                    if (TJAPlayer3.Tx.Effects_Fire != null)
                    {
                        ...
                        //this.ctゴーゴー.n現在の値 = 6;
                        TJAPlayer3.Tx.Effects_Fire.vc拡大縮小倍率 = new PointF(f倍率, f倍率);
                        TJAPlayer3.Tx.Effects_Fire.t2D拡大率考慮中央基準描画(TJAPlayer3.Skin.nScrollFieldX[i], TJAPlayer3.Skin.nJudgePointY[i] , new Rectangle(360 * (this.ctゴーゴー炎.n現在の値), 0, 360, 370));
                    }
                }
            }
            #endregion
                        ...
                        switch (st状態[i].judge)
                        {
                            ...
                            case E判定.Auto:
                                ...
                                if (this.st状態[i].nIsBig == 1 && TJAPlayer3.Tx.Effects_Hit_Great_Big[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Great_Big[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.Skin.nScrollFieldX[0] - TJAPlayer3.Tx.Effects_Hit_Great_Big[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.nJudgePointY[i] - TJAPlayer3.Tx.Effects_Hit_Great_Big[0].szテクスチャサイズ.Width / 2);
                                else if (TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.Skin.nScrollFieldX[0] - TJAPlayer3.Tx.Effects_Hit_Great[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.nJudgePointY[i] - TJAPlayer3.Tx.Effects_Hit_Great[0].szテクスチャサイズ.Width / 2);
                                break;
                            ...
                            case E判定.Good:
                                ...
                                if (this.st状態[i].nIsBig == 1 && TJAPlayer3.Tx.Effects_Hit_Good_Big[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Good_Big[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.Skin.nScrollFieldX[0] - TJAPlayer3.Tx.Effects_Hit_Good_Big[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.nJudgePointY[i] - TJAPlayer3.Tx.Effects_Hit_Good_Big[0].szテクスチャサイズ.Width / 2);
                                else if (TJAPlayer3.Tx.Effects_Hit_Good[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Good[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.Skin.nScrollFieldX[0] - TJAPlayer3.Tx.Effects_Hit_Good[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.nJudgePointY[i] - TJAPlayer3.Tx.Effects_Hit_Good[0].szテクスチャサイズ.Width / 2);
                                break;
        ...
        {
            this.n移動開始時刻 = (int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値;
        ...
        {
            this.n移動開始時刻2 = (int)TJAPlayer3.stage演奏ドラム画面.ct演奏用タイマー.db現在の値;
