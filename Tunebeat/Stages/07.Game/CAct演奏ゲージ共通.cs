...
namespace TJAPlayer3
{
	...
	internal class CAct演奏ゲージ共通 : CActivity
	{
        ...
        // ----------------------------------
        public float[ , ] fDamageGaugeDelta = {			// #23625 2011.1.10 ickw_284: tuned damage/recot進行Looper factors
			// drums,   guitar,  bass
		...
		public float[] fDamageLet進行LoopelFactor = {
			0.5f, 1.0f, 1.5f
		};
		...
		public void Damage( E楽器パート screenmode, E楽器パート part, E判定 e今回の判定, int player, int nコース )
		{
            nコース = TJAPlayer3.stage演奏ドラム画面.n次回のコース[player];
