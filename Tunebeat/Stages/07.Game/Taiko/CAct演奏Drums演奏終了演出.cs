...
namespace TJAPlayer3
{
    internal class CAct演奏Drums演奏終了演出 : CActivity
    {
        ...
        {
            this.b再生済み = false;
            this.soundClear = new CSound(CSkin.Path(@"Sounds\Clear.ogg"));
                            ...
                            if (TJAPlayer3.Tx.End_Clear_Text != null)
                            {
                                ...
                                if (this.ct進行メイン.n現在の値 >= 17)
                                {
                                    if (this.ct進行メイン.n現在の値 <= 36)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(634, (int)(y[i] - ((90 * f文字拡大率[this.ct進行メイン.n現在の値 - 17]) - 90)), new Rectangle(0, 0, 90, 90));
                                    }
                                    else
                                    {
                                        TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(634, y[i], new Rectangle(0, 0, 90, 90));
                                    }
                                }
                                if (this.ct進行メイン.n現在の値 >= 19)
                                {
                                    if (this.ct進行メイン.n現在の値 <= 38)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(692, (int)(y[i] - ((90 * f文字拡大率[this.ct進行メイン.n現在の値 - 19]) - 90)), new Rectangle(90, 0, 90, 90));
                                    }
                                    else
                                    {
                                        TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(692, y[i], new Rectangle(90, 0, 90, 90));
                                    }
                                }
                                TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                if (this.ct進行メイン.n現在の値 >= 21)
                                {
                                    if (this.ct進行メイン.n現在の値 <= 40)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(750, y[i] - (int)((90 * f文字拡大率[this.ct進行メイン.n現在の値 - 21]) - 90), new Rectangle(180, 0, 90, 90));
                                    }
                                    else
                                    {
                                        TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(750, y[i], new Rectangle(180, 0, 90, 90));
                                    }
                                }
                                if (this.ct進行メイン.n現在の値 >= 23)
                                {
                                    if (this.ct進行メイン.n現在の値 <= 42)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(819, y[i] - (int)((90 * f文字拡大率[this.ct進行メイン.n現在の値 - 23]) - 90), new Rectangle(270, 0, 90, 90));
                                    }
                                    else
                                    {
                                        TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(819, y[i], new Rectangle(270, 0, 90, 90));
                                    }
                                }
                                if (this.ct進行メイン.n現在の値 >= 25)
                                {
                                    if (this.ct進行メイン.n現在の値 <= 44)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(890, (y[i] + 2) - (int)((90 * f文字拡大率[this.ct進行メイン.n現在の値 - 25]) - 90), new Rectangle(360, 0, 90, 90));
                                    }
                                    else
                                    {
                                        TJAPlayer3.Tx.End_Clear_Text.vc拡大縮小倍率.Y = 1.0f;
                                        TJAPlayer3.Tx.End_Clear_Text.t2D描画(890, y[i] + 2, new Rectangle(360, 0, 90, 90));
                                    }
                                }
                                ...
                                else if (this.ct進行メイン.n現在の値 <= 46)
                                {
                                    if (TJAPlayer3.Tx.End_Clear_L[0] != null)
                                    {
                                        ...
                                        TJAPlayer3.Tx.End_Clear_L[0].vc拡大縮小倍率 = new PointF(fRet[this.ct進行メイン.n現在の値 - 36], 1.0f);
                                        //CDTXMania.Tx.End_Clear_R[ 0 ].t2D描画( CDTXMania.app.Device, 956 + (( this.ct進行メイン.n現在の値 - 36 ) / 2), 180 );
                                        TJAPlayer3.Tx.End_Clear_R[0].t2D描画((int)(1136 - 180 * fRet[this.ct進行メイン.n現在の値 - 36]), y[i] - 30);
                                        TJAPlayer3.Tx.End_Clear_R[0].vc拡大縮小倍率 = new PointF(fRet[this.ct進行メイン.n現在の値 - 36], 1.0f);
                                    }
                                }
