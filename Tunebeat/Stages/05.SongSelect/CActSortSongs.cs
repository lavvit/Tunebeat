...
namespace TJAPlayer3
{
	internal class CActSortSongs : CActSelectPopupMenu
	{
		...
		public CActSortSongs()
		{
            ...
            //lci.Add( new CItemList( "Let進行Loopel",		CItemBase.Eパネル種別.通常, 0, "", "", new string[] { "99,98,97,...",	"1,2,3,..." } ) );
		...
		//public void tDeatit進行LoopatePopupMenu()
		//{
		//	base.tDeatit進行LoopatePopupMenu();
		//}


		public override void tEnter押下Main( int nSortOrder )
		{
			this.act曲リスト = TJAPlayer3.stage選曲.act曲リスト;
