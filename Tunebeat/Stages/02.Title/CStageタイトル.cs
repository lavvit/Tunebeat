...
//					if ( CDTXMania.Input管理.Keyboard.IsPushedKey( (int) Key.Space ) )
//						Trace.TraceInformation( "DTXMania Title: SPACE key registered. " + CDTXMania.ct.nシステム時刻 );
				...
				if( TJAPlayer3.Tx.Title_Menu != null )
				{
					...
					if( this.ctカーソルフラッシュ用.n現在の値 <= 100 )
					{
                        ...
                        TJAPlayer3.Tx.Title_Menu.t2D描画( x_magnified, y_magnified, new Rectangle( 0, MENU_H * 5, MENU_W, MENU_H ) );
					}
                    TJAPlayer3.Tx.Title_Menu.vc拡大縮小倍率.X = 1f;
                    TJAPlayer3.Tx.Title_Menu.vc拡大縮小倍率.Y = 1f;
                    TJAPlayer3.Tx.Title_Menu.Opacity = 0xff;
                    TJAPlayer3.Tx.Title_Menu.t2D描画( x, y, new Rectangle( 0, MENU_H * 4, MENU_W, MENU_H ) );
				}
				if( TJAPlayer3.Tx.Title_Menu != null )
				{
                    ...
                    TJAPlayer3.Tx.Title_Menu.t2D描画( MENU_X, MENU_Y, new Rectangle( 0, 0, MENU_W, MENU_H ) );
                    TJAPlayer3.Tx.Title_Menu.t2D描画( MENU_X, MENU_Y + MENU_H, new Rectangle( 0, MENU_H * 2, MENU_W, MENU_H * 2 ) );
				}
