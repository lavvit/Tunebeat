...
namespace FDK
{
	public class CTraceLogListener : TraceListener
	{
		...
		public override void TraceEvent( TraceEventCache et進行LoopentCache, string source, TraceEventType et進行LoopentType, int id, string message )
		{
			if( this.streamWriter != null )
			{
				try
				{
					this.tイベント種別を出力する( et進行LoopentType );
					this.tインデントを出力する();
		...
		public override void TraceEvent( TraceEventCache et進行LoopentCache, string source, TraceEventType et進行LoopentType, int id, string format, params object[] args )
		{
			if( this.streamWriter != null )
			{
				try
		...
		private void tイベント種別を出力する( TraceEventType et進行LoopentType )
		{
			if( this.streamWriter != null )
			{
				try
