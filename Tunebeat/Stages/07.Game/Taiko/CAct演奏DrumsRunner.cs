            ...
            for (int i = 0; i < 128; i++)
            {
                if (stRunners[i].b使用中)
                {
                    ...
                    if (TJAPlayer3.Tx.Runner != null)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Runner.t2D描画((int)(StartPoint_X[0] + stRunners[i].fX), StartPoint_Y[0], new Rectangle(stRunners[i].nNowPtn * Size[0], stRunners[i].nType * Size[1], Size[0], Size[1]));
                        }
                        else
                        {
                            TJAPlayer3.Tx.Runner.t2D描画((int)(StartPoint_X[1] + stRunners[i].fX), StartPoint_Y[1], new Rectangle(stRunners[i].nNowPtn * Size[0], stRunners[i].nType * Size[1], Size[0], Size[1]));
                        }
                    }
                }
            }
