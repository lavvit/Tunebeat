		...
		public override int On進行描画()
		{
			...
			if( !base.b活性化してない )
			{
				...
				if( TJAPlayer3.Tx.Exit_Background != null )
				{
                    ...
                    //{
                    //    if( this.ds背景.b上下反転 )
                    //        this.tx背景.t2D上下反転描画( CDTXMania.app.Det進行Loopice, 0, 0 );
                    //    else
                    //        this.tx背景.t2D描画( CDTXMania.app.Det進行Loopice, 0, 0 );
                    //}
                    //else
           ...
           //             this.tx文字2.t2D描画( CDTXMania.app.Det進行Loopice, 1100 - (int)( 1.30f * this.ct時間稼ぎ.n現在の値), 1600 - (int)( 1.6f * this.ct時間稼ぎ.n現在の値), new System.Drawing.Rectangle( 0, 0, 620, 92 )  );
           //             this.tx文字3.t2D描画( CDTXMania.app.Det進行Loopice, -250 + (int)( 1.10f * this.ct時間稼ぎ.n現在の値), 1600 - (int)( 1.6f * this.ct時間稼ぎ.n現在の値), new System.Drawing.Rectangle( 0, 92, 620, 94 )  );
           //         }
           //     }
           //     else
           //     {
           ...
           //             this.tx文字2.t2D描画( CDTXMania.app.Det進行Loopice, 480, 376, new System.Drawing.Rectangle( 0, 0, 620, 92 )  );
           //             this.tx文字3.t2D描画( CDTXMania.app.Det進行Loopice, 500, 486, new System.Drawing.Rectangle( 0, 92, 620, 95 )  );
           //             this.tx文字.t2D描画( CDTXMania.app.Det進行Loopice, 662, 613, new System.Drawing.Rectangle( 0, 187, 620, 44 )  );
           //         }
           ...
           //         if( this.tx白 != null )
			        //{
				       ...
				       // {
					      //  for( int j = 0; j <= ( 720 / 64 ); j++ )
					      //  {
           //                     this.tx白.t2D描画( CDTXMania.app.Det進行Loopice, i * 64, j * 64 );
					      //  }
				       // }
			        //}
           //     }
