...
namespace TJAPlayer3
{
    class PuchiChara : CActivity
    {
        ...
        public override void On活性化()
        {
            ...
            SineCounter = new CCounter(0, 360, TJAPlayer3.Skin.Game_PuchiChara_SineTimer, null);
            base.On活性化();
        }
        ...
        public void ChangeBPM(double bpm)
        {
            ...
            SineCounter = new CCounter(1, 360, TJAPlayer3.Skin.Game_PuchiChara_SineTimer * bpm / 180, null);
        }
        ...
        public int On進行描画(int x, int y, bool isGrowing, int alpha = 255, bool isBalloon = false)
        {
            ...
            TJAPlayer3.Tx.PuchiChara.vc拡大縮小倍率 = new PointF((isBalloon ? TJAPlayer3.Skin.Game_PuchiChara_Scale[1] : TJAPlayer3.Skin.Game_PuchiChara_Scale[0]), (isBalloon ? TJAPlayer3.Skin.Game_PuchiChara_Scale[1] : TJAPlayer3.Skin.Game_PuchiChara_Scale[0]));
            TJAPlayer3.Tx.PuchiChara.Opacity = alpha;
            TJAPlayer3.Tx.PuchiChara.t2D中心基準描画(x, y + (int)sineY, new Rectangle(Counter.n現在の値 * TJAPlayer3.Skin.Game_PuchiChara[0], (isGrowing ? TJAPlayer3.Skin.Game_PuchiChara[1] : 0), TJAPlayer3.Skin.Game_PuchiChara[0], TJAPlayer3.Skin.Game_PuchiChara[1]));
            return base.On進行描画();
        }
