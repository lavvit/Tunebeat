...
namespace FDK
{
	public class CActivity
	{
		...
		public virtual void On活性化()
		{
			...
			// すべての子 Actit進行Loopity を活性化する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.On活性化();
		...
		public virtual void On非活性化()
		{
			...
			// すべての 子Actit進行Loopity を非活性化する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.On非活性化();
		...
		public virtual void OnManagedリソースの作成()
		{
			...
			// すべての 子Actit進行Loopity の Managed リソースを作成する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.OnManagedリソースの作成();
		}
		...
		public virtual void OnUnmanagedリソースの作成()
		{
			...
			// すべての 子Actit進行Loopity の Unmanaged リソースを作成する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.OnUnmanagedリソースの作成();
		}
		...
		public virtual void OnUnmanagedリソースの解放()
		{
			...
			// すべての 子Actit進行Loopity の Unmanaged リソースを解放する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.OnUnmanagedリソースの解放();
		}
		...
		public virtual void OnManagedリソースの解放()
		{
			...
			// すべての 子Actit進行Loopity の Managed リソースを解放する。
			foreach( CActivity actit進行Loopity in this.list子Activities )
				actit進行Loopity.OnManagedリソースの解放();
		}
