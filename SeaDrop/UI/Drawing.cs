...
namespace SeaDrop
{
    public class Drawing
    {
        ...
        public static void Line(double x, double y, double rangeX, double rangeY, int color = 0xffffff, int alpha = 255, bool antiAging = true)
        {
        ...
        /// <param name="color">色</param>
        /// <param name="antiAging">アンチエイジングをするか</param>
        public static void Box(double x, double y, double rangeX, double rangeY, int color = 0xffffff, int alpha = 255, bool fill = true, bool antiAging = true)
        {
            SetDrawBlendMode(DX_BLENDMODE_ALPHA, alpha);
        ...
        /// <param name="color">色</param>
        /// <param name="antiAging">アンチエイジングをするか</param>
        public static void Triangle(double x1, double y1, double x2, double y2, double x3, double y3, int color = 0xffffff, int alpha = 255, bool fill = true, bool antiAging = true)
        {
            SetDrawBlendMode(DX_BLENDMODE_ALPHA, alpha);
        ...
        public static void Circle(double x, double y, double r, int color = 0xffffff, int alpha = 255, bool fill = true, bool antiAging = true, int posnum = 64)
        {
            SetDrawBlendMode(DX_BLENDMODE_ALPHA, alpha);
        ...
        /// <param name="antiAging">アンチエイジングをするか</param>
        /// <param name="posnum">アンチエイジング時の円の細かさ</param>
        public static void Oval(double x, double y, double rX, double rY, int color = 0xffffff, int alpha = 255, bool fill = true, bool antiAging = true, int posnum = 64)
        {
            SetDrawBlendMode(DX_BLENDMODE_ALPHA, alpha);
        ...
        /// <param name="color">色</param>
        public static void Text(int x, int y, object text, int color = 0xffffff)
        {
        ...
        public static void Text(int x, int y, int size, object text, int color = 0xffffff)
        {
            SetFontSize(size);
            DrawString(x, y, $"{text}", (uint)color);
            SetFontSize(16);
        ...
        public static void Text(int x, int y, object text, string font, int color = 0xffffff)
        {
            ChangeFont(font);
            DrawString(x, y, $"{text}", (uint)color);
            ChangeFont("");
        ...
        /// <param name="size">大きさ</param>
        /// <param name="font">フォント</param>
        public static void Text(int x, int y, int size, object text, string font, int color = 0xffffff)
        {
            SetFontSize(size);
            ChangeFont(font);
            DrawString(x, y, $"{text}", (uint)color);
        ...
        public static void Text(int x, int y, object text, Handle handle, int color = 0xffffff)
        {
        ...
        public static int TextWidth(object text, Handle handle = null)
        {
        ...
        /// <returns>テキストの幅</returns>
        public static int TextWidth(object text, int length, Handle handle = null)
        {
        ...
        /// <returns>テキストの幅</returns>
        public static int TextWidth(object text, int start, int length, Handle handle = null)
        {
        ...
        /// <param name="text">テキスト群</param>
        /// <returns>テキストの幅</returns>
        public static int TextWidth(List<object> text, Handle handle = null)
        {
            int size = 0;
