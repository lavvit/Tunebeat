...
namespace SeaDrop
{
    ...
    public class Texture : IDisposable, ITextureReturnable
    {
        ...
        public void Draw(double x, double y, double opacity, Rectangle? rectangle = null, Point? drawOrigin = null, bool reverseX = false, bool reverseY = false)
        {
            double op = Opacity;
            Opacity = opacity;
            Draw(x, y, rectangle, drawOrigin, reverseX, reverseY);
            Opacity = op;
        }
        /// <summary>
        /// 描画します。
        ...
        /// <param name="x">X座標。</param>
        /// <param name="y">Y座標。</param>
        /// <param name="scaleX">X拡大率。</param>
        /// <param name="scaleY">Y拡大率。</param>
        /// <param name="rectangle">描画範囲。</param>
        /// <param name="drawOrigin">描画基準点。指定するとReferencerPointを無視する。</param>
        /// <param name="reverseX">横方向に反転描画するか。</param>
        /// <param name="reverseY">縦方向に反転描画するか。</param>
        public void Draw(double x, double y, double scaleX, double scaleY, Rectangle? rectangle = null, Point? drawOrigin = null, bool reverseX = false, bool reverseY = false)
        {
        ...
        /// <param name="reverseX">横方向に反転描画するか。</param>
        /// <param name="reverseY">縦方向に反転描画するか。</param>
        public void Draw(double x, double y, double opacity, double scaleX, double scaleY, Rectangle? rectangle = null, Point? drawOrigin = null, bool reverseX = false, bool reverseY = false)
        {
            double op = Opacity, scX = ScaleX, scY = ScaleY;
            Opacity = opacity;
            ScaleX = scaleX;
            ScaleY = scaleY;
            Draw(x, y, rectangle, drawOrigin, reverseX, reverseY);
