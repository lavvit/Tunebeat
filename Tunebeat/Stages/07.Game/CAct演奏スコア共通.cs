        ...
        private float[,] n点数アニメ拡大率_座標 = new float[,]
{
		...
		public void Add( E楽器パート part, STAUTOPLAY bAutoPlay, long delta, int player )
		{
			...
			this.Set( part, this.Get( part, player ) + delta * ret進行Loop, player );
		}
                    ...
                    if( this.stFont[ i ].ch == ch )
                    {
                        ...
                        switch( mode )
                        {
                            case 0:
                                ...
                                {
                                    //this.txScore.color4 = new DxLibDLL.Color4( 1.0f, 1.0f, 1.0f );
                            ...
                            case 1:
                                ...
                                {
                                    //this.txScore.color4 = new DxLibDLL.Color4( 1.0f, 0.5f, 0.4f );
                            ...
                            case 2:
                                ...
                                {
                                    //this.txScore.color4 = new DxLibDLL.Color4( 0.4f, 0.5f, 1.0f );
